...
@Component({
  selector: 'app-formas-pagamento-detalhe',
  templateUrl: './formas-pagamento-detalhe.component.html',
  styleUrls: ['./formas-pagamento-detalhe.component.css'],
  animations: [
    trigger(
      'enterAnimation', [
        transition(':enter', [
...
export class FormasPagamentoDetalheComponent implements OnInit {
